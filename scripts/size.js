 ...
 *
 * Bundles the BROWSER variant of each entry (the package.json `browser` field
 * swaps `src/runtime/node.js` for `src/runtime/browser.js`) exactly the way a
 * consumer's bundler would, then reports:
 ...
 *
 * Run with `pnpm size`. Optional peer tooling (jsep, zod, ajv, typebox,
 * @opentelemetry/api) is not part of the package and not included.
 */
