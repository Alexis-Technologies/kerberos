...
function buildExpensePolicy({ version = 'default', scope } = {}) {
  return {
    resourcePolicy: {
      version,
      ...(scope ? { scope } : {}),
...
const expensePolicy = buildExpensePolicy();
const expenseScopedPolicy = buildExpensePolicy({ version: '20210210', scope: 'acme.corp' });

module.exports = { buildExpensePolicy, expensePolicy, expenseScopedPolicy };
